...
class MainActivity : AppCompatActivity() {
    ...
    private val opcionMenuSelecionada = BottomNavigationView.OnNavigationItemSelectedListener {item->
...
false
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navegacion.setOnNavigationItemSelectedListener(opcionMenuSelecionada)
